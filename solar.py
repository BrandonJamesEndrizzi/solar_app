...
def build_report(start_date, end_date):
    ...
    image_paths = [data_downloading.download_image(key) for key in IMAGE_KEYS]
    ...
    if image_paths:
        sunspot_count, annotated_image = process_sun_image(image_paths[0])
